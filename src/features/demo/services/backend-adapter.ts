...
export function adaptBootstrap(payload: BootstrapPayload): DemoState {
  ...
  return { employees, tasks, approvals, activities, integrations: initialDemoState.integrations, financialAccounts: [], financialCollectionEvents: [], financialDocuments: [], financialEntries: [], anaAuditEvents: [], financialHandoffs: [], financialBudgets: [] };
}
